...
<?php
		...
		$sql = "SELECT student_mahasiswa.*, akademik_konsentrasi.nama_konsentrasi as nama_konsentrasi, akademik_krs.accept as acc, akademik_krs.konversi as aksemester FROM akademik_krs
			...
			WHERE student_mahasiswa.nim like '%".$cari."%' or student_mahasiswa.nama like '%".$cari."%'
			...
			<td>
				<div class="inline-block">
				    ...
				    <ul class="split-content d-menu" data-role="dropdown">
						<li><a target="_BLANK" href="<?= $_url ?>krs_fakultas/krs-mhs/<?= $field['nim'] ?>/<?= urlencode($field['nama']) ?>"><span class="mif-zoom-in"></span> View</a></li>
