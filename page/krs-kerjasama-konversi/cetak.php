...
$loadkerjasama = mysqli_query($koneksi,"SELECT kerjasama FROM student_mahasiswa WHERE nim='$_username'");
$kerjasama = mysqli_fetch_array($loadkerjasama);
$mhs= mysqli_fetch_array($loadbayar);
//echo $mhs['status'];
if ($mhs['status']==1 and $kerjasama['kerjasama']!=1):
 	?>
