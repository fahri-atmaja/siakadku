...
<a target="_BLANK" href="<?= $_url ?>transkrip/cetak/<?= $_id ?>" class="button success">Cetak</a>
...
<table class="table striped hovered border bordered">
	...
	<tfoot><tr><td colspan='2' align='right'>Jumlah</td><td><?php $total_sks= $sks+$sks_kon;
			echo $total_sks; ?></td><td colspan=2></td><td><?php $total_nb = $nb+$nbk; echo $total_nb; ?></td></tr>
			<tr><td colspan='2' align='right'>Indeks Prestasi</td><td></td><td colspan=2></td><td><?php echo number_format($total_nb/$total_sks,2) ?></td></tr>
	</tfoot>
</table>