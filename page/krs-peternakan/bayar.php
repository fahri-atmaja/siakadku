...
<?php
	...
	$sql = "SELECT bsk.*, bs.jenis_sks, bs.biaya FROM bayar_sks_peternakan as bsk, biaya_sks as bs, student_mahasiswa as sm
						WHERE bsk.status=0 and bsk.id_sks=bs.id_sks and sm.id_sks=bs.id_sks and bsk.nim='$_username' limit 1";
