...
<?php
	...
	$sql1 = "SELECT sm.*, ak.nama_konsentrasi, bs.jenis_sks, ba.total_biaya, ba.jumlah_angsur FROM student_mahasiswa as sm, biaya_sks as bs, akademik_konsentrasi as ak, biaya_angsuran as ba WHERE sm.konsentrasi_id=ak.konsentrasi_id AND ba.konsentrasi_id=ak.konsentrasi_id AND sm.id_sks=bs.id_sks AND sm.status_angsur='1' AND sm.id_sks='2' AND sm.kpt!='1' AND sm.beasiswa!='1' AND sm.nim like '%".$cari."%'
			 ORDER BY nama_konsentrasi ASC ";
	$query1 = mysqli_query($koneksi, $sql1);
}
  else {
$sql1 = "SELECT sm.*, ak.nama_konsentrasi, bs.jenis_sks, ba.total_biaya, ba.jumlah_angsur FROM student_mahasiswa as sm, biaya_sks as bs, akademik_konsentrasi as ak, biaya_angsuran as ba WHERE sm.konsentrasi_id=ak.konsentrasi_id AND ba.konsentrasi_id=ak.konsentrasi_id AND sm.id_sks=bs.id_sks AND sm.status_angsur='1' AND sm.id_sks='2' AND sm.kpt!='1' AND sm.beasiswa!='1'
			 ORDER BY nama_konsentrasi ASC ";
	$query1 = mysqli_query($koneksi, $sql1);
}
?>
