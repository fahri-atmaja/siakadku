...
$query = mysqli_query($koneksi, "DELETE FROM biaya_angsuran WHERE id='{$_id}'");
...
<a href="<?= $_url ?>angsuran/delete/<?= $_id ?>/yes" class="button primary">Yes</a> <a href="<?= $_url ?>angsuran/biaya_angsuran" class="button danger">No</a>