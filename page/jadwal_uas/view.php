...
<?php
    ...
    $sql1   = "SELECT akademik_krs.nim, jadwal_kuliah.tanggal, jadwal_kuliah.jam, app_ruangan.nama_ruangan, akademik_jadwal_kuliah.semester, akademik_jadwal_kuliah.jadwal_id, akademik_kelas.nama_kelas,makul_matakuliah.nama_makul,app_dosen.nama_lengkap FROM jadwal_kuliah
        ...
        WHERE akademik_krs.nim='$_username'
        ";
