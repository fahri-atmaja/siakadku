...
<a href="<?= $_url ?>dosen/approve/<?= $field['nim'] ?>/<?= urlencode($field['nama']) ?>"><span class="mif-pencil"></span> Setujui </a>
<a href="<?= $_url ?>dosen/disapprove/<?= $field['nim'] ?>/<?= urlencode($field['nama']) ?>"><span class="mif-pencil"></span> Batal Setujui </a>
