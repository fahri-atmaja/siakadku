...
$querya =mysqli_query($koneksi,"SELECT akademik_jadwal_kuliah.*,akademik_kelas.nama_kelas,makul_matakuliah.nama_makul, app_dosen.nama_lengkap, app_hari.hari, dosen_junior.nama_dos FROM akademik_jadwal_kuliah
...
$jam_selesai	= $_POST['jam_selesai'];
	...
	$sql = "UPDATE akademik_jadwal_kuliah SET jadwal_id='{$_id}',tahun_akademik_id='$tahun', konsentrasi_id='$konsentrasi',
	makul_id='$makul',hari_id='$hari',ruangan_id='$ruang',dosen_id='$dosen',dosen_id2='$dosen2',semester='$semester',
	jam_mulai='$jam_mulai',jam_selesai='$jam_selesai',id_kelas='$kelas'";
