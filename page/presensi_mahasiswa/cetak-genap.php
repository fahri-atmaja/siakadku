...
?>
		...
		<tr>
			<?php
			$per1 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='9'");
			...
			<!-- -->
			<?php
			$per2 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='10'");
			...
			<!-- -->
			<?php
			$per3 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='11'");
			...
			<!-- -->
			<?php
			$per4 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='12'");
			...
			<!-- -->
			<?php
			$per5 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='13'");
			...
			<!-- -->
			<?php
			$per6 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='14'");
			...
			<!-- -->
			<?php
			$per7 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='15'");
			...
			<!-- -->
			<?php
			$per8 = mysqli_query($koneksi,"SELECT tanggalabsen FROM mhs_absen WHERE jadwal_id='$_id' AND pertemuan='16'");
	...
	?>
		...
		<tr>
			...
			<td>
			<?php
			$absen1 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='9'");
			...
			<td>
			<?php
			$absen2 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='10'");
			...
			<td>
			<?php
			$absen3 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='11'");
			...
			<td>   
			<?php
			$absen4 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='12'");
			...
			<td>
			<?php
			$absen5 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='13'");
			...
			<td>
			<?php
			$absen6 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='14'");
			...
			<td>
			<?php
			$absen7 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='15'");
			...
			<td>
			<?php
			$absen8 = mysqli_query($koneksi,"SELECT * FROM mhs_absen WHERE nim='$field[nim]' AND jadwal_id='$field[jadwal_id]' AND pertemuan='16'");
