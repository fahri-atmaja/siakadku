    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM app_dosen WHERE nip='{$username}' AND password=md5('{$password}')";
        ...
        if (mysqli_num_rows($query) == 1) {
            ...
            $_SESSION['username'] = $field['nip'];
            $_SESSION['name'] = $field['nama_lengkap'];
            echo "<script>$.Notify({
...
<br>
<form method="post">
    <h1 class="text-dark">Login Dosen</h1>
        <hr class="thin"/>
        <br />
  <div class="form-group">
    <label for="username">NIDN</label>
    <input type="text" class="form-control" id="username" name="username" aria-describedby="emailHelp" placeholder="Enter NIDN" pattern="[a-zA-Z0-9!@#$%^*_|]{6,25}" onKeyDown="limitText(this,15);" 
onKeyUp="limitText(this,15);">
    <small id="emailHelp" class="form-text text-muted">isikan nidn anda, apabila belum terdaftar silahkan hubungi admin sistem.</small>
  </div>
  <div class="form-group">
