...
<a href="<?= $_url ?>krs/approve/<?= $field['nim'] ?>/<?= urlencode($field['nama']) ?>"><span class="mif-pencil"></span> Setujui </a>
<a href="<?= $_url ?>krs/disapprove/<?= $field['nim'] ?>/<?= urlencode($field['nama']) ?>"><span class="mif-pencil"></span> Batal Setujui </a>
