...
<?php
	if(isset($_GET['cari'])){
		$cari = $_GET['cari'];
	$sql1 = "SELECT bsk.*,bs.biaya ,bs.jenis_sks, sm.nama ,ak.nama_konsentrasi FROM bayar_sks_peternakan as bsk, biaya_sks as bs, student_mahasiswa as sm, akademik_konsentrasi as ak
			...
			<td>
				<div class="inline-block">
				    ...
				    <ul class="split-content d-menu" data-role="dropdown">
						<li><a href="<?= $_url ?>sks-peternakan/approved/<?= $field1['biaya_id'] ?>/<?= urlencode($field1['nim']) ?>"><span class="icon mif-school"></span> Bayar</a></li>
						<li><a href="<?= $_url ?>sks-peternakan/bayar/<?= $field1['biaya_id'] ?>/<?= urlencode($field1['nim']) ?>"><span class="icon mif-school"></span> Cetak Bukti Bayar</a></li>
				    </ul>
				</div>
			</td>
		</tr>
