...
?>
<h3>LAPORAN ANGSURAN PEMBAYARAN MAHASISWA KONVERSI BULANAN
<br>Bulan <?= $bulan[(int)$_id];?> Tahun <?= $_params[1] ?></h3>
<!-- <h3>Semester <?= $semester ?> Tahun <?= $keterangan ?> </h3> -->
</center>

<?php
	$sql = "SELECT akb.*, sm.nama FROM angsuran_konversi_bayar as akb, student_mahasiswa as sm 
				WHERE sm.nim=akb.nim and month(akb.tanggal)='$_id' and year(akb.tanggal)='$_params[1]' ORDER BY akb.nim ASC";
