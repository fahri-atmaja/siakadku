...
LAPORAN ANGSURAN BIAYA KULIAH KPT
</h1>
<form method="GET">
Bulan
<select name="bulan">
...
$tahun = $_GET['tahun'];
?>
<a target="_BLANK" href="<?= $_url ?>report/cetak-kpt/<?= $bulan?>/<?= urlencode($tahun) ?>" class="button success">Cetak</a>
<?php
endif;
?>
<?php
if(isset($_GET['bulan']))
{
				$bulan = $_GET['bulan'];
				$tahun = $_GET['tahun'];
				$sql1 = "SELECT ba.*, sm.nama FROM angsuran_kpt as ba, student_mahasiswa as sm 
