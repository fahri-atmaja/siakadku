...
<?php
	...
	$sql1 = "SELECT sm.*, ak.nama_konsentrasi, bs.jenis_sks, ba.total_biaya, ba.jumlah_angsur FROM student_mahasiswa as sm, biaya_sks as bs, akademik_konsentrasi as ak, biaya_angsuran as ba WHERE sm.konsentrasi_id=ak.konsentrasi_id AND ba.konsentrasi_id=ak.konsentrasi_id AND sm.id_sks=bs.id_sks AND sm.status_angsur='1' AND sm.kpt='1' AND sm.beasiswa='0' AND sm.nim like '%".$cari."%'
			 ORDER BY nama_konsentrasi ASC ";
	$query1 = mysqli_query($koneksi, $sql1);
}
  else {
$sql1 = "SELECT sm.*, ak.nama_konsentrasi, bs.jenis_sks, ba.total_biaya, ba.jumlah_angsur FROM student_mahasiswa as sm, biaya_sks as bs, akademik_konsentrasi as ak, biaya_angsuran as ba WHERE sm.konsentrasi_id=ak.konsentrasi_id AND ba.konsentrasi_id=ak.konsentrasi_id AND sm.id_sks=bs.id_sks AND sm.status_angsur='1' AND sm.kpt='1' AND sm.beasiswa='0'
			 ORDER BY nama_konsentrasi ASC ";
	$query1 = mysqli_query($koneksi, $sql1);
}
?>
			...
			<td>
				<div class="inline-block">
				    ...
				    <ul class="split-content d-menu" data-role="dropdown">
						<li><a href="<?= $_url ?>angsuran_kpt/bayar_angsuran/<?= $field1['nim'] ?>/<?= urlencode($field1['jumlah_angsur']) ?>"><span class="icon mif-school"></span> Bayar Angsur</a></li>
