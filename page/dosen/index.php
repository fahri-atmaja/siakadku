...
<span class="place-right">
	...
	<!-- <a href="<?= $_url ?>dosen/import" class="button">Import Dosen</a> -->
</span>
</h1>
<form action="#" method="GET">
<div class="panel" data-role="panel">
    <div class="heading">
        <span class="title">Cari Dosen</span>
    </div>
    <div class="grid">
    	<input type="text" name="cari" value="">
    	<input type="submit" value="Cari NIP">
    </div>
  </div>
</form>
  <?php
...
<?php
	if(isset($_GET['cari'])){
		$cari = $_GET['cari'];
	$sql = "SELECT * FROM app_dosen WHERE nip like '%".$cari."%'";
