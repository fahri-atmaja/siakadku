...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO app_dosen (nip,nidn,password,status,nama_lengkap,alamat,gender,prodi_id,konsentrasi_id,gelar_pendidikan)
			values('$nipdos','$nidndos', (md5('$password')),'$status', '$nama_lengkap', '$alamat', '$gender', '$prodi_id', '$konsentrasi_id', '$gelar_pendidikan')";
	...
	<div class="cell">
		...
		<div class="form-group">
			...
			<select name="konsentrasi_id" required="">
				<option value=""></option>
				<?php
					$query = mysqli_query($koneksi, "SELECT * FROM akademik_konsentrasi ORDER BY prodi_id");
					while ($field = mysqli_fetch_array($query)) {
