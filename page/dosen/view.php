...
<div class="panel" data-role="panel">
    ...
    <div class="content">
		<?php
			...
			$sqlb = "select jk.jadwal_id,akls.nama_kelas,ak.nama_konsentrasi,mm.kode_makul,mm.nama_makul,mm.sks,mm.semester,ad.nama_lengkap
			FROM akademik_jadwal_kuliah as jk,akademik_konsentrasi as ak,makul_matakuliah as mm,app_dosen as ad,akademik_kelas as akls
			WHERE jk.konsentrasi_id=ak.konsentrasi_id and jk.makul_id=mm.makul_id and jk.dosen_id=ad.dosen_id and jk.id_kelas=akls.id_kelas and ad.nip='$_id' Order By ak.nama_konsentrasi, akls.nama_kelas ASC";
...
?>
			...
			<tfoot><tr><td colspan='2' align='right'>Total SKS yang ditempuh</td><td></td><td></td><td><?php 
