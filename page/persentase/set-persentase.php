...
<form Method="POST">
	...
	<div class="form-group">
		...
		<label for="semester">KEHADIRAN :</label>
			<input class="form-control" type="text" name="kehadiran" id="kehadiran" onkeypress="return hanyaAngka(event)" maxlength="2" required>
		<label for="semester">TUGAS :</label>
			<input class="form-control" type="text" name="tugas" id="tugas" onkeypress="return hanyaAngka(event)" maxlength="2" required>	
	...
	<div class="form-group">
		...
		<label for="semester">UTS :</label>
			<input class="form-control" type="text" name="uts" id="uts" onkeypress="return hanyaAngka(event)" maxlength="2" required>
		<label for="semester">UAS :</label>
			<input class="form-control" type="text" name="uas" id="uas" onkeypress="return hanyaAngka(event)" maxlength="2" required>
	</div>
	</td>
	<td>
