...
<?php
	...
	$sql = "SELECT akademik_krs.*, makul_matakuliah.kode_makul, makul_matakuliah.nama_makul, makul_matakuliah.sks, app_dosen.nama_lengkap, akademik_konsentrasi.nama_konsentrasi as jurusan FROM
        akademik_krs
