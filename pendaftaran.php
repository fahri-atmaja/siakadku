...
$koneksi        = mysqli_connect('localhost','smilefoo_siakad','(password)','smilefoo_wp');
$nik            = $_POST['nik'];
$nisn           = $_POST['nisn'];
$nama           = $_POST['nama'];
$email          = $_POST['email'];
...
$insert = mysqli_query($koneksi,"INSERT INTO student_mahasiswa (nim,nikmhs,password,nama,id_sks,id_kelas,status_angsur,
                                    ...
                                    '0','0','$angkatan_id','$alamat','1','$jenkel','$kdagama','$tpt_lahir','$tgl_lahir','$nmibu','$nmayah','$asal_sekolah',
...
// kurang database ospek dan ukuran almamater
// $insert = mysqli_query($koneksi,"INSERT INTO student_mahasiswa (nim, nikmhs, password, nama, id_sks, id_kelas, status_angsur, konsentrasi_id, kpt) 
//                         VALUES('$fixnim','$nik',md5('$tgl_lahir'),'$nama','$id_sks','$id_kelas','1','$konsentrasi_id','0')");
if($insert){
